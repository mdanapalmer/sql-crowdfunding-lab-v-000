...
"SELECT projects.title, SUM(pledges.amount) - projects.funding_goal AS excess FROM projects JOIN pledges ON projects.id GROUP BY projects.title HAVING excess >= 0 DESC LIMIT 2;"
end
