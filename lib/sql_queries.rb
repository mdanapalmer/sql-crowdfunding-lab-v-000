...
"SELECT projects.title, SUM (pledges.amount) - projects.funding_goal AS excess FROM projects JOIN pledges ON projects.id WHERE projects.funding_goal <= 0 = pledges.project_id GROUP BY projects.title LIMIT 2;"
end
