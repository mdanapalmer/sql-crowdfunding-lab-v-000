...
"SELECT projects.title, SUM (pledges.amount) - projects.funding_goal AS excess FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title LIMIT 2;"
end
