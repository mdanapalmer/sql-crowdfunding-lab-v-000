...
"SELECT projects.title, SUM(pledges.amount) - SUM (projects.funding_goal) FROM projects JOIN pledges ON projects.id = pledges.projects.if GROUP BY projects.title;"
end
